...
jest.mock('@radix-ui/react-select', () => ({
  ...
  Value: React.forwardRef(({ children, ...props }, ref) => (
    <span ref={ref} data-testid="select-value" {...props}>
      {children}
    </span>
  )),
  Portal: React.forwardRef(({ children, ...props }, ref) => (
  ...
  ItemText: React.forwardRef(({ children, ...props }, ref) => (
    <span ref={ref} data-testid="select-item-text" {...props}>
      {children}
    </span>
  )),
  ItemIndicator: React.forwardRef(({ children, ...props }, ref) => (
    <span ref={ref} data-testid="select-item-indicator" {...props}>
      {children}
    </span>
  )),
  Label: React.forwardRef(({ children, ...props }, ref) => (
    <span ref={ref} data-testid="select-label" {...props}>
      {children}
    </span>
  )),
  ...
  Group: React.forwardRef(({ children, ...props }, ref) => (
    <div ref={ref} data-testid="select-group" {...props}>
      {children}
    </div>
  )),
  ScrollUpButton: React.forwardRef(({ children, ...props }, ref) => (
    <div ref={ref} data-testid="select-scroll-up-button" {...props}>
      {children}
    </div>
  )),
  ScrollDownButton: React.forwardRef(({ children, ...props }, ref) => (
    <div ref={ref} data-testid="select-scroll-down-button" {...props}>
      {children}
    </div>
  )),
  Icon: React.forwardRef(({ children, asChild, ...props }, ref) => (
